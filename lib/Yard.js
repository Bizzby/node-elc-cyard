...
Yard.prototype.fabricate = function(callback) {
  ...
  var plugins = this._pluginPaths.map(_mapPluginPathsToPlugins);
  ...
  function _mapPluginPathsToPlugins(pluginPath){
    return self._pluginLoader(self._basePath, pluginPath)
  }

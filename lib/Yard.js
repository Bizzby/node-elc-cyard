...
Yard.prototype.fabricate = function(callback) {
  ...
  var pluginMap = this._pluginArrayToMap(plugins);
...
Yard.prototype._checkFactories = function(factories) {
  factories.forEach(this._checkFactory);
}

Yard.prototype._checkFactory = function(module, name){
...
Yard.prototype._pluginArrayToMap = function(plugins) {
